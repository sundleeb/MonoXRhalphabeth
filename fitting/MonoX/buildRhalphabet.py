...
class dazsleRhalphabetBuilder: 
	...
	def RhoSafetyCheck(self, H, ptbin):
	...
	def LoopOverPtBins(self):
		...
		# for ipt in range(1,2):
			...
			for ih,h in enumerate(self._hpass):
				...
				self.RhoSafetyCheck(tmppass_inPtBin, ipt)
			...
			for ih,h in enumerate(self._hfail):
				...
				self.RhoSafetyCheck(tmpfail_inPtBin, ipt)
	...
	def makeWorkspace(self,iOutput,iDatas,iFuncs,iVars,iCat="cat0",iShift=True):
		...
		interpolatedMasses = [15.,20.,30.,35.,40.,45.,55.,60.0,65.,70.,80.,85.,90.0,95.,105.,110.0,115.,120.,130.,135.0,140.,145.,155.,160.,165.0,170.,175.,180.0,185.,190.,195.]
...
##-------------------------------------------------------------------------------------
def loadHistograms(f1,pseudo,pseudo15):
	...
	#signals
	masses=[10,25,50,75,100,125,200]
	for mass in masses:
...
if __name__ == '__main__':
	...
	parser.add_option('--input', dest='input', default = 'ZGammaTemplates.root',help='directory with data', metavar='idir')
