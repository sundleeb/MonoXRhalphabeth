...
def plotCategory(fml,fd,index,fittype,mass,usemlfit,tf):
	...
	print "STARTING TO PLOT A CATEGORY"
	...
	for i,ish in enumerate(shapes):	
		...
		print "ch%i_fail_cat%i/%s" % (index,index,ish)
...
if __name__ == '__main__':
	...
	parser.add_option('--idir', dest='idir', default = '',help='choice is either prefit, fit_sb or fit_b', metavar='fit')
